        ...
        <div>
            ...
            <div className='grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3'>
                {getGamesBygenresid.map((item,index)=>(
                    <div className='m-3 transition-all duration-300 ease-in-out hover:scale-105 flex flex-col items-center bg-slate-300 dark:bg-slate-600 h-[400px] cursor-pointer rounded-xl'>
